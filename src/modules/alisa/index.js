...
import * as light from './src/command/light';
import welcome from './src/command/welcome';
import skills from './src/command/skills';
import myDevices from './src/command/my-devices';
import any from './src/command/any';
